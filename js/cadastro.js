...
let nomedopet = document.querySelector('#nomedopet')
let labelNomedopet = document.querySelector('#labelNomedopet')
let validNomedopet = false

let raca = document.querySelector('#raca')
let labelRaca = document.querySelector('#labelRaca')
let validRaca = false

let idadepet = document.querySelector('#idadepet')
let labelIdadedopet = document.querySelector('#labelIdadedopet')
let validIdadedopet = false
...
endereco.addEventListener('keyup', () => {
  if(endereco.value.length <= 4){
    ...
    labelEndereco.innerHTML = 'Favor insira o Endereço'
    usuario.setAttribute('style', 'border-color: red')
    validEndereco = false
  } else {
...
nomedopet.addEventListener('keyup', () => {
